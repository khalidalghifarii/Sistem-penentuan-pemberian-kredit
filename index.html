        ...
        <div class="l-wrapper">
          ...
          <ul class="l-main-content main-content">
            <li class="l-section section section--is-active">
              <div class="intro">
                <div class="flex-wrapper">
                  ...
                  <div>
                    <h1 style="color: white;" class="lilita-one-regular font-bold">Sistem Penentuan <br> Pemberian Kredit</h1>
                  </div>
                      ...
                      <form id="creditForm" action="process.php" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <select id="occupation" name="occupation" required>
                            ...
                            <option value="Wiraswasta Menengah">Wiraswasta Menengah</option>
                            <option value="Wiraswasta Besar">Wiraswasta Besar</option>
                        ...
                        <div class="form-group">
                          <label style="font-weight: bold; color: white;" for="income">Penghasilan per Bulan
                            (Rp)</label>
            ...
            <li class="l-section section">
              <div class="work">
                <img src="assets/img/Component 12.png" alt=""
                  style="display: block; margin: auto; width: 80%; height: auto; margin-left: 20%;">
              </div>
            </li>
            ...
            <li class="l-section section">
              <div class="about">
                <h1 style="color: white; margin-left: 300px;"  class="lilita-one-regular1">Tim Kami</h1>
                  ...
                  <ul class="slider" >
                    <li class="slider--item slider--item-left">
                      <a href="#0">
                        ...
                        <p class="slider--item-title">Zahra Zafira <br> 2208107010066</p>
                        </a>
                    </li>
                    ...
                    <li class="slider--item slider--item-left">
                      <a href="#0">
                        ...
                        <p class="slider--item-title">Khalid Al Ghifari <br> 2208107010044</p>
                      </a>
                    </li>
              ...
              <div class="contact">
                <div class="contact--lockup">
                  ...
                  <ul class="modal--options">
                    ...
                    <li><a href="mailto:jamrija mustopal@gmail.com">Hubungi Kami</a></li>
                  </ul>
                </div>
                </div>
              </div>
